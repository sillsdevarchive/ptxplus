...
%                \else\setbox0\hbox{-}-\kern-1.5pt\kern\wd0\penalty\hyphenpenalty \AdornVerseNumber{\v@rseto}\fi}
				...
				% djd - 20111108 / Further notes on this: The line in use now
				% (top one) puts the hyphen at the start of the second line.
				% This was changed to go back to the way it was done in 2009.
				% Not sure if this is good or not.  I think I like the hyphen at
				% the end of the number on the fist line, but for now it will
				% stay like this.
