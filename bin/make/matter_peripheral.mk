...
$(PATH_TEXTS)/$(1) :
	@echo WARNING: Peripheral item: $(PATH_TEXTS)/$(1) missing adding template to project.
...
make-topic-index :
	@$(PY_PROCESS_SCRIPTURE_TEXT) make_topic_index_file 'NA' $(PATH_SOURCE)/TOPICAL_INDEX.CSV $(PATH_TEXTS)/TOPICAL_INDEX.USFM
